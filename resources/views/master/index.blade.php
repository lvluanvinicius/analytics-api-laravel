...
<body class="bg-white text-black dark:text-white dark:bg-dracula-darker-800">

    <header class="px-4 py-2 dark:bg-dracula-darker shadow-md dark:shadow-dracula-darker-100/5 gap-3 flex">
        <button class="outline-none px-2" type="button" data-drawer-target="drawer-navigation"
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('onus.index') }}"
                        ...
                        <span class="ml-3">Dashboard Onus</span>
                    </a>
                </li>
                <li>
                    <button type="button"
